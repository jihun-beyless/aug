...
class TransactionAugment(aug_protobuf_pb2_grpc.TransactionAugmentServicer):
    ...
    def SendAugmentData(self, AugType, context):
        ...
        aug_flag = aug_start.aug_start(device_id = AugType.device_id, grid = g, grid_id = AugType.grid_id, object_category = obj_cate, background_id = AugType.background_id, iteration= AugType.iteration, batch_num = batch)
